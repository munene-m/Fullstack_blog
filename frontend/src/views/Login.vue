    ...
    <div class="max-w-sm w-72 mt-14 md:w-96 md:mb-6 border-none">
        <form class="w-full px-6 py-16 items-center flex flex-col justify-center bg-slate-800 border rounded-xl shadow-sm" @submit.prevent="handleSubmit">
            ...
            <div class="flex flex-col relative pb-4">
                <h4 class="text-white text-sm cursor-pointer md:text-base">Don't have an account?<span class="text-purple-500 font-bold hover:text-purple-700"><RouterLink to="/sign-up">Sign up</RouterLink></span></h4>
            </div>
            <div>
                <button type="submit" class="text-white bg-purple-600 rounded-md border-none px-4 cursor-pointer py-2">Log in</button>
            </div>
        </form>
